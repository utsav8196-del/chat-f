        ...
        <section>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                <h2 className="text-2xl sm:text-3xl font-bold tracking-tight">
                  Recommended for You <Compass className="inline size-6 ml-1" />
                </h2>
          ...
          {loadingUsers ? (
            ...
            <div className="card bg-base-200 p-6 text-center">
              <Compass className="mx-auto size-8 opacity-30 mb-2" />
              ...
              <p className="text-base-content opacity-70 max-w-md mx-auto">
                You've added all the available friends or there aren't any new users to connect with right now.
                <br />
                Invite someone to join or check back later!
              </p>
            </div>
          ) : (
