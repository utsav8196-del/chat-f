...
var _AttachmentManager = class _AttachmentManager2 {
  constructor({ composer, message }) {
    ...
    this.doDefaultUploadRequest = async (fileLike, options2) => {
      ...
      const axiosUploadConfig = progressHandler || options2?.abortSignal ? {
        ...progressHandler ? { onUploadProgress: progressHandler } : {},
        ...options2?.abortSignal ? { signal: options2.abortSignal } : {}
      } : void 0;
    ...
    handlers: {
      onChange: ({ state, next, complete, forward }) => {
        ...
        if (commandName) {
          ...
          const composer = options2?.composer;
...
//# sourceMappingURL=chunk-YWWHJMKP.js.map
