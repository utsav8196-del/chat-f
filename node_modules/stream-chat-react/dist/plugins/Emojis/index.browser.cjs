...
var import_react12 = __toESM(require("@emoji-mart/react"));
...
function autoMiddlewareFor(p) {
  ...
  return (0, import_react7.autoPlacement)({ alignment });
}
function toOffsetMw(opt) {
  if (opt == null) return null;
  if (Array.isArray(opt)) {
    const [crossAxis, mainAxis] = opt;
    return (0, import_react7.offset)({ crossAxis, mainAxis });
  }
  if (typeof opt === "number") return (0, import_react7.offset)(opt);
  return (0, import_react7.offset)(opt);
}
function usePopoverPosition({
  ...
  const middleware = [
    ...
    ...autoMw ? [autoMw] : allowFlip && !isSidePlacement ? [(0, import_react7.flip)()] : [],
    // viewport collision adjustments
    ...allowShift ? [(0, import_react7.shift)({ padding: 8 })] : [],
    // optional size constraining
    // eslint-disable-next-line @typescript-eslint/no-empty-function
    ...fitAvailableSpace ? [(0, import_react7.size)({ apply: () => {
    } })] : []
  ];
  const seedPlacement = String(placement).startsWith("auto") ? "bottom" : placement;
  return (0, import_react7.useFloating)({
    middleware,
    placement: seedPlacement,
    strategy: "fixed",
    whileElementsMounted: freeze ? void 0 : (reference, floating, update) => (0, import_react7.autoUpdate)(reference, floating, update, {
      ancestorResize: true,
      ancestorScroll: true,
...
var LegacyThreadContext = import_react8.default.createContext({ legacyThread: void 0 });
var useLegacyThreadContext = () => (0, import_react8.useContext)(LegacyThreadContext);
...
var useMessageComposer = () => {
  ...
  const cachedEditedMessage = (0, import_react9.useMemo)(() => {
    if (!editedMessage) return void 0;
    return editedMessage;
  }, [editedMessage?.id]);
  const cachedParentMessage = (0, import_react9.useMemo)(() => {
    if (!parentMessage) return void 0;
    return parentMessage;
  }, [parentMessage?.id]);
  const messageComposer = (0, import_react9.useMemo)(() => {
...
var MessageInputContext = (0, import_react10.createContext)(
  void 0
);
var useMessageInputContext = (componentName) => {
  const contextValue = (0, import_react10.useContext)(MessageInputContext);
  if (!contextValue) {
    return {};
  }
  return contextValue;
...
var EmojiPicker = (props) => {
  ...
  const [displayPicker, setDisplayPicker] = (0, import_react11.useState)(false);
  const [referenceElement, setReferenceElement] = (0, import_react11.useState)(
    null
  );
  ...
  return /* @__PURE__ */ import_react11.default.createElement("div", { className: props.wrapperClassName ?? wrapperClassName }, displayPicker && /* @__PURE__ */ import_react11.default.createElement(
    "div",
    {
    ...
    ButtonIconComponent && /* @__PURE__ */ import_react11.default.createElement(ButtonIconComponent, null)
  ));
};
